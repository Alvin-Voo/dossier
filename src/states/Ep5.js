...
export default class Ep5 extends Phaser.State{
  ...
  create(){
    ...
    //add weapons
    this.map.createFromObjects('weapons',196,'objects4','shurikens',true,false,this.collectablesGroup,Collectables);
    ...
    this.player = new Player(this.game,1780,1950);//start pos
    ...
    this.map.createFromObjects('ratninjas',195,'ratninja','throwframe1',true,false,this.ratGroup,RatNinja);
    this.ratGroup.forEach((ratNinja)=>{
      ratNinja.player=this.player;
    },this);
    ...
    this.cheeseScore = new CheeseScore(this.game,460,20,19);
    ...
    this.player.shurikens.forEach((shuriken)=>{
      ...
      shuriken.body.collides([ratCG,catCG,catBallsCG,ninjaShurikenCG],this.playerHitListener,this);
    },this);
    ...
    this.titletext =  new TitleText(this.game,'Ep 5. The Ninja Reality');
