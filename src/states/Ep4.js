...
export default class Ep4 extends Phaser.State{
  ...
  create(){
    ...
    this.map.createFromObjects('movingwaves',13,'objects1','watertile',true,false,this.world,WavesObjects);
    ...
    //add weapons
    this.map.createFromObjects('weapons',26,'objects4','shurikens',true,false,this.collectablesGroup,Collectables);
    ...
    this.player = new Player(this.game,2340,2860);//start pos
    ...
    this.map.createFromObjects('ratgrunts',16,'ratgrunt','frame0',true,false,this.ratGroup,RatGrunt);
    ...
    this.map.createFromObjects('cats',23,'cat','frame0',true,false,this.catGroup,Cat);
    ...
    this.cheeseScore = new CheeseScore(this.game,460,20,18);
    ...
    this.player.shurikens.forEach((shuriken)=>{
      ...
      shuriken.body.collides([ratCG,catCG,catBallsCG],this.playerHitListener,this);
    },this);
    ...
    this.titletext =  new TitleText(this.game,'Ep 4. The Shooting Stars');
  ...
  tipspopper(index){
    ...
    let tip = this.cache.getJSON('config').popup.ep4.tips[index];
